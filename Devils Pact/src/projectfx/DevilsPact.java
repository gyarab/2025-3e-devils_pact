...
public class DevilsPact extends Application {
    ...
    static int MAP_W = 14;
    static int MAP_H = 7;
    static final int UI_HEIGHT = 50;
    static final int ROOM_MIN = 2, ROOM_MAX = 4;
    static final int MAX_MAP_W = 14;
    static final int MAX_MAP_H = 7;
    ...
    static final String[] ITEM_IMAGES = {
        ...
        "/Assets/Items/item_7.png",
        "/Assets/Items/item_8.png",
        "/Assets/Items/item_9.png",
    ...
    Player player;
    Point2D stairsPos = null;
    int floorLevel = 1;
    
    int earlyDuoCount = 0; 
    int lateDuoCount = 0;  
    
    Image heroBasicImage = null;
    Image heroLeftImage = null;
    Image heroRightImage = null;

    Image heroBasicImage2x = null;
    Image heroLeftImage2x = null;
    Image heroRightImage2x = null;
    
    Image heroAttack1 = null;
    Image heroAttack2 = null;
    Image heroAttack3 = null;
    ...
    Image stairsImage = null;
    Image closedStairsImage = null;
    Image topWallImage = null;
    Image bottomWallImage = null;
    Image leftWallImage = null;
    Image rightWallImage = null;
    
    Image sideLeftWallImage = null;
    Image sideRightWallImage = null;

    Image cornerLeftWallImage = null;
    Image cornerRightWallImage = null;

    Image basicFightImage = null;
    Image chestImage = null;
    Image fightImage = null;
    Image shopImage = null;

    Image fightBgImage = null;
    Image chestBgImage = null;
    Image chestBgOpenImage = null;
    Image shopBgImage = null;

    Image merchantImage = null;
    Image merchantImageMiddle = null;
    Image merchantImageLow = null;
    Image shopTableImage = null;
    ...
    Timeline getAttackAnim(ImageView view, int eId) {
        ...
        if (eId >= 1 && eId <= 8) {
            ...
            if (eId == 1 || eId == 3 || eId == 6 || eId == 8) {
                anim.getKeyFrames().addAll(
                    new KeyFrame(Duration.ZERO, e -> { 
                        if (a1 != null) view.setImage(a1); 
                    }),
                    new KeyFrame(Duration.seconds(0.1), e -> { 
                        view.setTranslateX(startX - 15); 
                    }),
                    new KeyFrame(Duration.seconds(0.2), e -> { 
                        if (a2 != null) view.setImage(a2); 
                    }),
                    ...
                    new KeyFrame(Duration.seconds(0.5), e -> { 
                        if (base != null) view.setImage(base); 
                    })
                );
            } else {
                anim.getKeyFrames().addAll(
                    ...
                    new KeyFrame(Duration.seconds(0.075), e -> { 
                        view.setTranslateX(startX - 10); 
                    }),
                    new KeyFrame(Duration.seconds(0.15), e -> { 
                        if (a2 != null) view.setImage(a2); 
                    }),
                    new KeyFrame(Duration.seconds(0.225), e -> { 
                        view.setTranslateX(startX - 25); 
                    }),
                    ...
                    new KeyFrame(Duration.seconds(0.525), e -> { 
                        if (a1 != null) view.setImage(a1); 
                    }),
            ...
            anim.getKeyFrames().addAll(
                ...
                new KeyFrame(Duration.seconds(0.125), e -> { 
                    if (a1 != null) view.setImage(a1); 
                }),
                new KeyFrame(Duration.seconds(0.25), e -> { 
                    if (a2 != null) view.setImage(a2); 
                ...
                new KeyFrame(Duration.seconds(0.375), e -> { 
                    if (a3 != null) view.setImage(a3); 
                }),
                new KeyFrame(Duration.seconds(0.5), e -> { 
                    if (a3 != null) view.setImage(a4); 
                }),
                new KeyFrame(Duration.seconds(0.625), e -> { 
                    if (base != null) view.setImage(base); 
                })
            );
        }
        ...
        if (inRoom) {
            if (currentRoom == RoomType.SHOP) {
                if (k == KeyCode.DIGIT1) {
                    ...
                    buyShopItem();
                } else if (k == KeyCode.SPACE || k == KeyCode.ESCAPE) {
                    exitRoom();
                }
                return;
            }
    ...
    boolean checkFightWinCondition() {
        if (currentEnemyHp <= 0) {
            ...
            if (currentEnemyView != null) {
                currentEnemyView.setVisible(false);
            }
        }
        if (currentEnemy2Hp <= 0) {
            currentEnemy2Hp = 0;
            if (currentEnemy2View != null) {
                currentEnemy2View.setVisible(false);
            }
        }
    ...
    void performPlayerAttack() {
        ...
        do { 
            attackRoll = rng.nextInt(6) + 1; 
        } while(player.hasItem[8] && attackRoll == 1);
        
        do { 
            healRoll = rng.nextInt(6) + 1;   
        } while(player.hasItem[8] && healRoll == 1);
        
        do { 
            shieldRoll = rng.nextInt(6) + 1; 
        } while(player.hasItem[8] && shieldRoll == 1);
        ...
        attackDiceView.setFitWidth(150); 
        attackDiceView.setFitHeight(150);
        attackDiceView.setTranslateX(targetX); 
        attackDiceView.setTranslateY(targetY);

        ImageView healDiceView = new ImageView(healDiceImages[finalHealRoll - 1]);
        healDiceView.setFitWidth(150); 
        healDiceView.setFitHeight(150);
        healDiceView.setTranslateX(targetX - 170); 
        healDiceView.setTranslateY(targetY);

        ImageView shieldDiceView = new ImageView(shieldDiceImages[finalShieldRoll - 1]);
        shieldDiceView.setFitWidth(150); 
        shieldDiceView.setFitHeight(150);
        shieldDiceView.setTranslateX(targetX + 170); 
        shieldDiceView.setTranslateY(targetY);

        ImageView animView = new ImageView(rollAnimationImages[0]);
        animView.setFitWidth(700); 
        animView.setFitHeight(700);
        animView.setTranslateX(targetX-250); 
        animView.setTranslateY(targetY - 700);
    ...
    void playAttackAnimation(int damage, int heal, int shieldVal) {
        if (heroFightTimeline != null) {
            heroFightTimeline.pause(); 
        }
        ...
        Timeline anim = new Timeline(
            new KeyFrame(Duration.ZERO, e -> { 
                if (heroAttack1 != null) {
                    heroInFight.setImage(heroAttack1); 
                }
            }),
            new KeyFrame(Duration.seconds(0.05), e -> { 
                if (heroAttack2 != null) {
                    heroInFight.setImage(heroAttack2); 
                }
                heroInFight.setTranslateX(startX + 2); 
            }),
            new KeyFrame(Duration.seconds(0.1), e -> {
                if (heroAttack3 != null) {
                    heroInFight.setImage(heroAttack3);
                }
                ...
                if (player.hasItem[9] && damage >= 5) {
                    actualHeal += 3; 
                }
                if (player.hasItem[10] && player.hp < 20) {
                    actualDamage *= 2;
                }
                ...
                if (isDuoFight) {
                    ...
                    } else if (currentEnemy2Hp > 0) {
                        currentEnemy2Hp -= actualDamage;
                    }
                } else {
                    currentEnemyHp -= actualDamage;
                }
    ...
    void performEnemyAttack() {
        ...
        if (enemy1IdleTimeline != null) {
            enemy1IdleTimeline.pause();
        }
        if (enemy2IdleTimeline != null) {
            enemy2IdleTimeline.pause();
        }
        ...
        Timeline seq = new Timeline(
            new KeyFrame(Duration.seconds(1.0), e -> {
                ...
                if (player.hp <= 0) {
                    ...
                    isAnimating = false;
                    lostScreenGroup.setVisible(true);
                } else {
                    if (player.hasItem[7]) {
    ...
    void enterRoom(RoomType roomType, int enemyId) {
        ...
        switch (roomType) {
            case BASIC_FIGHT: 
                bgImage = fightBgImage; 
                showMessage("Entered Fight Room!", Color.RED); 
                break;
            case BOSS_FIGHT: 
                bgImage = fightBgImage; 
                showMessage("Entered Boss Room!", Color.RED); 
                break;
            case CHEST: 
                bgImage = chestBgImage; 
                isChestOpened = false; 
                showMessage("Entered Chest Room!", Color.GOLD); 
                break;
            case SHOP: 
                bgImage = shopBgImage; 
                showMessage("Entered Shop!", Color.CYAN); 
                break;
        }
        ...
        instructionBg.setStroke(Color.WHITE); 
        instructionBg.setStrokeWidth(5);
        ...
        if (roomType == RoomType.CHEST) {
            ...
            if (merchantImage != null) {
                ...
                double mWidth = TILE * 3;
                double mHeight = TILE * 3;
                merchant.setFitWidth(mWidth); 
                merchant.setFitHeight(mHeight); 
            ...
            if (shopTableImage != null) {
                ...
                table.setFitWidth(MAX_MAP_W * TILE); 
                table.setFitHeight(MAX_MAP_H * TILE);
            ...
            if (heroBasicImage2x != null && heroLeftImage2x != null && heroRightImage2x != null) {
                ...
                heroInFight.setFitWidth(TILE * 3); 
                heroInFight.setFitHeight(TILE * 3); 
                heroInFight.setPreserveRatio(true);
                heroInFight.setTranslateX(150); 
                heroInFight.setTranslateY(425);
            ...
            if (enemyId >= 1 && enemyId <= 8) {
                ...
                img1 = ENEMY_IDLE_IMGS[1][0]; 
                img2 = ENEMY_IDLE_IMGS[1][0]; 
            } else if (enemyId == 12) { 
                img1 = ENEMY_IDLE_IMGS[4][0]; 
                img2 = ENEMY_IDLE_IMGS[5][0]; 
            } 
            ...
            if (img1 != null) {
                ...
                currentEnemyView.setFitWidth(ENEMY_WIDTH[eId1]); 
                currentEnemyView.setFitHeight(ENEMY_HEIGHT[eId1]); 
                currentEnemyView.setPreserveRatio(true);
                
                if (isDuoFight) {
                    currentEnemyView.setTranslateX(ENEMY_DUO_X1[eId1]);
                } else {
                    currentEnemyView.setTranslateX(ENEMY_SOLO_X[eId1]);
                }
            ...
            if (isDuoFight && img2 != null) {
                ...
                currentEnemy2View.setFitWidth(ENEMY_WIDTH[eId2]); 
                currentEnemy2View.setFitHeight(ENEMY_HEIGHT[eId2]); 
                currentEnemy2View.setPreserveRatio(true);
                currentEnemy2View.setTranslateX(ENEMY_DUO_X2[eId2]); 
                currentEnemy2View.setTranslateY(ENEMY_Y[eId2]);
            ...
            if (startButtonImage != null) {
                ...
                attackButtonView.setFitWidth(280); 
                attackButtonView.setPreserveRatio(true);
    ...
    void exitRoom() {
        ...
        if (currentEnemy2View != null) { 
            currentEnemy2View.setVisible(false); 
            currentEnemy2View = null; 
        }
        
        isDuoFight = false; 
        currentEnemy2Hp = 0; 
        attackButtonView = null; 
        isAnimating = false; 
        uiEnemyHp.setVisible(false);
        ...
        if (merchantTimeline != null) { 
            merchantTimeline.stop(); 
            merchantTimeline = null; 
        }
        if (heroFightTimeline != null) { 
            heroFightTimeline.stop(); 
            heroFightTimeline = null; 
        }
        if (enemy1IdleTimeline != null) { 
            enemy1IdleTimeline.stop(); 
            enemy1IdleTimeline = null; 
        }
        if (enemy2IdleTimeline != null) { 
            enemy2IdleTimeline.stop(); 
            enemy2IdleTimeline = null; 
        }
    ...
    void carveCorridor(int x1, int y1, int x2, int y2) {
        ...
        int y = y1;
        while (x != x2) { 
            if (x >= 0 && x < MAX_MAP_W && y >= 0 && y < MAX_MAP_H) {
                map[x][y] = TileType.FLOOR; 
            }
            x += (x < x2) ? 1 : -1; 
        }
    ...
    boolean isFloorOrStairs(int x, int y) {
        if (x < 0 || y < 0 || x >= MAX_MAP_W || y >= MAX_MAP_H) {
            return false;
        }
                ...
                if (map[x][y] == TileType.WALL) {
                    ...
                    if (bordersTop || bordersBottom || bordersLeft || bordersRight) {
                        if (bordersBottom && topWallImage != null) {
                            ...
                            wallTile.setFitWidth(TILE);
                            wallTile.setFitHeight(TILE);
                            wallTile.setTranslateX(posX);
                            wallTile.setTranslateY(posY);
                    ...
                    if (stairsOpen) {
                        if (stairsImage != null) {
                            ...
                            stairsTile.setFitWidth(TILE);
                            stairsTile.setFitHeight(TILE);
                            stairsTile.setTranslateX(posX);
                            stairsTile.setTranslateY(posY);
                        ...
                        stairText.setFont(Font.font(24));
                        stairText.setFill(Color.WHITE);
                    ...
                    if (floorImage != null) {
                        ...
                        floorTile.setFitWidth(TILE);
                        floorTile.setFitHeight(TILE);
                        floorTile.setTranslateX(posX);
                        floorTile.setTranslateY(posY);
            ...
            for (int y = 0; y < MAX_MAP_H; y++) {
                ...
                if (lx >= 0 && lx < MAP_W && map[lx][y] == TileType.WALL && !isFloorOrStairs(lx, y+1)) {
                    if (sideRightWallImage != null) {
                        ...
                        sv.setFitWidth(TILE);
                        sv.setFitHeight(TILE);
                        sv.setTranslateX(lx * TILE);
                        sv.setTranslateY(posY);
            ...
            for (int y = 0; y < MAX_MAP_H; y++) {
                ...
                if (lx >= 0 && lx < MAP_W && map[lx][y] == TileType.WALL && !isFloorOrStairs(lx, y-1)) {
                    if (cornerLeftWallImage != null) {
                        ...
                        cv.setFitWidth(TILE);
                        cv.setFitHeight(TILE);
                        cv.setTranslateX(lx * TILE);
                        cv.setTranslateY(posY);
    ...
    void placeShapes(int excludeX, int excludeY) {
        ...
        for (int x = 0; x < MAP_W; x++) {
            for (int y = 0; y < MAP_H; y++) {
                if (map[x][y] == TileType.FLOOR) {
                    if (stairsPos != null && x == stairsPos.getX() && y == stairsPos.getY()) {
                        continue;
                    }
        ...
        switch(floorLevel) {
            ...
            case 4: 
                ...
                break;
            case 5: 
                addShape(ShapeType.FIGHT, 9, floorPositions.get(posIndex++)); 
                addShape(ShapeType.CHEST, -1, floorPositions.get(posIndex++)); 
                break;
            case 6: 
                addShape(ShapeType.SHOP, -1, floorPositions.get(posIndex++)); 
            ...
            case 10: 
            default: 
                addShape(ShapeType.FIGHT, 10, floorPositions.get(posIndex++)); 
                break;
        }
    }
    ...
    void checkShapeCollision() {
        for (ShapeObject shape : shapeObjects) {
            if (player.x == shape.x && player.y == shape.y) {
                ...
                switch (shape.type) {
                    case BASIC_FIGHT: 
                        roomType = RoomType.BASIC_FIGHT; 
                        break;
                    case FIGHT:       
                        roomType = RoomType.BOSS_FIGHT;  
                        break;
                    case CHEST:       
    ...
    void updateUI() {
        ...
        if (inRoom && (currentRoom == RoomType.BASIC_FIGHT || currentRoom == RoomType.BOSS_FIGHT)) {
            ...
            if (isDuoFight && currentEnemy2Hp > 0) {
                roomEnemies++;
            }
        ...
        for (int i = 1; i <= 10; i++) {
            if (player.hasItem[i]) {
                if (loadedItems[i - 1] != null) {
                    ...
                    iv.setFitWidth(40); 
                    iv.setFitHeight(40); 
                    iv.setTranslateX(invStartX + index * 45); 
                    iv.setTranslateY(5);
    ...
    class ShapeObject {
        ...
        ShapeObject(int x, int y, ShapeType type) {
            ...
            switch (type) {
                case BASIC_FIGHT:
                    shapeIcon = basicFightImage;
                    break;
                case CHEST:
                    shapeIcon = chestImage;
                    break;
                case SHOP:
                    shapeIcon = shopImage;
                    break;
                case FIGHT:
                    shapeIcon = fightImage;
                    break;
            }
            
            if (shapeIcon != null) { 
                ImageView iv = new ImageView(shapeIcon); 
                iv.setFitWidth(TILE * 0.7); 
                iv.setFitHeight(TILE * 0.7); 
                iv.setPreserveRatio(true); 
                sprite = iv; 
            } else { 
                Rectangle rect = new Rectangle(TILE * 0.7, TILE * 0.7);
                rect.setFill(type.color);
    ...
    class Player extends Entity {
        ...
        int maxHp = 50;
        int coins = 0; 
        boolean[] hasItem = new boolean[11]; 
        ...
        Player(int x, int y) {
            ...
            if (heroBasicImage != null && heroLeftImage != null && heroRightImage != null) {
                ...
                imageView.setFitWidth(TILE); 
                imageView.setFitHeight(TILE); 
